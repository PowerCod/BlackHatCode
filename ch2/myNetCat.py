...
def usage():
    ...
    print "-u --upload=destination   -upon receiving connection upload a file on write to[destination]"
    print
    print
    print "Examples:"
    ...
    print "echo 'ABCDEFG' | ./myNetCat.py -t 192.168.11.12 -p 135"
    sys.exit(0)
...
def client_handler(client_socket):
    ...
    if len(upload_destination):
        ...
        try:
            ...
            client_socket.send("Successful saved file to %\r\n" % upload_destination)
        except:
